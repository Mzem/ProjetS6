...
class addQualitativesTest(unittest.TestCase): 
    ...
    def test_calculEffectifs(self):
        ...
        self.assertEquals(listeEffectifs, res)                  # Vérification du résultat 
    ...
    def test_calculEffectifsCumules(self):
        ...
        self.assertEquals(listeEffectifsCumules, res)               # Vérification du résultat 
    ...
    def test_calculFrequences(self):
        ...
        self.assertEquals(listeFrequence, res)  # Vérification du résultat
    ...
    def calculFrequencesCumules(self):
        ...
        self.assertEquals(listeFrequenceCumules, res)  # Vérification du résultat 
