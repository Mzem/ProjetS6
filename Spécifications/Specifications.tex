				...
				\vspace{1em}\item Fonctionnalité de vérification de l'ouverture du fichier :
					...
					\underline{Paramètres :}
						\begin{description}[style=unboxed,leftmargin=0.2cm]
							\item\lstinline!fichierCSV! : \lstinline!TextIoWrapper! - type représentant les entrées/sorties en général, dont les fichiers : le paramètre représente le fichier CSV fourni.
						\end{description}
