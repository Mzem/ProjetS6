...
\newpage\clearpage\pagenumbering{arabic}
	...
	\section{Package Interface web}
		...
		Ce module est une fenêtre graphique web qui permet à l'utilisateur de charger un fichier CSV. Ce module aura 2 fonctionnalités qui peuvent être illustrées par les croquis suivants :
			...
			\begin{center}\includegraphics[scale=0.5]{Fenetre_choix_fichier1.jpg}\end{center} 
			\begin{center}\includegraphics[scale=0.4145]{Fenetre_choix_fichier2.jpg}\end{center}
	...
	\section*{Conclusion}
		...
		\paragraph{}Néanmoins, et dans un cadre pédagogique, cette épreuve ne sera qu'enrichissante pour nous, non seulement sur le plan compétence, mais aussi expérience.
