...
\newpage\clearpage\pagenumbering{arabic}
	...
	\section{Package Interface web}
		...
		\begin{enumerate} 
				...
				\vspace{1em}\item Fonctionnalité pour la demande d'exportation.
					\begin{lstlisting}
						sauvResultats()
					\end{lstlisting}
					\underline{Paramètres :}
						\begin{description}[style=unboxed,leftmargin=0.2cm]
							\item Ne prend pas de paramètre.
						\end{description}
					\underline{Retour :} Ne retourne rien.\\
					\underline{Description :} cette fonction ne prend aucun paramètre. Elle s'active lorsque l'utilisateur fait la demande d'exporter les résultats. Le téléchargement sera alors lancé par le navigateur web.
