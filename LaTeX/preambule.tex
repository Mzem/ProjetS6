...
\usepackage{lmodern,mathptmx,changepage,titlesec,xcolor,hyperref,listings,lstautogobble,graphicx,array,longtable,multirow,lipsum}
...
\hypersetup{colorlinks=true, allcolors=blue, allbordercolors=blue}
