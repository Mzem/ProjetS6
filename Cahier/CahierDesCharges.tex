...
\newpage\clearpage\pagenumbering{arabic}
	...
	\section{Autres aspects du projet}
		...
		\subsection{Tâche à faire}
			...
			Le développement du produit se décompose en deux étapes. La première étant la Spécification pour établir le squelette du produit, ainsi que les différents algorithmes qui seront utilisés. Et la seconde étape sera la Programmation de l'application web demandé.
