...
\newpage\clearpage\pagenumbering{arabic}
	...
	\section{Exigences fonctionnelles}
		...
		\subsection{Présentation de l'organigramme et des fonctionnalités}
			...
			\textbf{API 2 : Analyse descriptive de données}
...
-					\item anomalies : boîte à moutaches de Tukey
	...
	\\
	Pour finir, il est intéressant de mentionner les diffcultées rencontrées au cours de l'élaboration du cahier des charges.\\
	Le plus difficile a été pour nous d'apprendre une nouvelle démarche tout en la pratiquant dans un projet de grande ampleur pour des étudiants. Ceci entraine des efforts supplémentaires au niveau de l'organisation et de la gestion des délais à cause du double travail exigé.\\
	Cela dit, ce premier travail nous a permis à la fois de réaliser l'impact des efforts individuels et collectifs pour mettre à bien un travail qui semble \textit{a priori} difficile, mais aussi d'aborder de nouveaux projets avec une approche plus pragmatique.\\
