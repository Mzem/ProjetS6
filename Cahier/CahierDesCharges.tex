...
\newpage\clearpage\pagenumbering{arabic}
	...
	\section{Exigences non fonctionnelles}
		...
		\colorbox{yellow}{Dans le template y a pas cette partie}\\
		\colorbox{yellow}{mais y a "Adéquation du produit avec son environnement" qui découle de la partie "Contraintes/Environnement"}\\
