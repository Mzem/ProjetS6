...
\section{Guide Pratique}
	...
	\subsection{Étape 3-Résultats}
		...
		Pour le cas des séries temporelles, il y a un graphe disponible par arc différent. Afin de consulter la série temporelle voulue, il faut cliquer sur le bouton radio correspondant.
		\begin{center}\includegraphics[scale=0.40]{fenetre3Arcs.png}\end{center}
