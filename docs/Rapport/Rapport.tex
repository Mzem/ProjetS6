...
\newpage\clearpage\pagenumbering{arabic}
	...
	%QUoi marche pas (pb et et resolution si trouvee)
		...
		\subsection{Problèmes rencontrés}
			\subsubsection*{Problèmes résolus :} gestion des routes avec flask, application de flitres sur les données et pagination, traitement de fichiers mal structurés, Objet TextIOWrapper non sérialisable, 
