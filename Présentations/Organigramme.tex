...
\newpage\clearpage\pagenumbering{arabic}
	...
	\section{Coûts}
		\begin{center}\begin{longtable}{|>{\centering}m{3cm}|>{\centering}m{4cm}|>{\centering\arraybackslash}m{7cm}|}			
				...
				\hline 	Quantitatif Continu & 20 + 10 + 10 + 5 + 20*2 & Parcours + choix précision classe d'intervale + écriture + comunication avec les modules+ calcul des valeurs pour la construction de 2 graphes\\
